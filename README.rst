...
You will need Python 3.3 because jinja2 depends on that version. If you run Ubuntu 12.04 you can circumvent that by install jinj2 before installing the tool::
